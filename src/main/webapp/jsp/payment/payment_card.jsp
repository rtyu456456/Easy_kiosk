...
<body>
	...
	<span class="payment-card-finalPrice-text">결제 가격 : </span>
	<span class="payment-card-finalPrice">${sessionScope.user.finalPrice}원</span>
	</c:if>
	...
	<span class="payment-card-finalPrice-text">결제 가격 : </span>
	<span class="payment-card-finalPrice">${sessionScope.user.totalPrice}원</span>
	</c:if>
	</span>
